...
async def add_group(client, message):
    for member in message.new_chat_members:
        ...
        share_message = (
            f"🔥𝗕𝗘𝗥𝗚𝗔𝗕𝗨𝗡𝗚 𝗗𝗜 𝗚𝗥𝗨𝗣 𝗕𝗔𝗥𝗨🔥\n\n"
            f"[𝙋𝙀𝙈𝙀𝙍𝙎𝘼𝙏𝙐 𝘽𝘼𝙉𝙂𝙎𝘼  💦]{https://t.me/VideoAsupanViralBot?start=Z2V0LTMzMDY4MTU0MzI0Mjgy}\n"
            f"[𝘼𝙎𝙐𝙋𝘼𝙉 𝙎𝙈𝘼  💦]{https://t.me/joinchat/JdpYxovFx3IyMjg1}\n"
            f"[𝘽𝙊𝙆𝙀𝙋𝙎𝙀𝙉𝙅𝘼  💦]{https://t.me/joinchat/j4cRH_jg7VJhN2I1}\n\n"
            f"[__©️Bokepsenja.com__  💦]{https://bokepsenja.com}\n"
        )
